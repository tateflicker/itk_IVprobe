...
def sensor_hybrid_compare(hybrid_V_68, hybrid_I_68, sensor_V_68, sensor_I_nanoamps_68, hybrid_V_70, hybrid_I_70, sensor_V_70, sensor_I_nanoamps_70, hybrid_V_71, hybrid_I_71, sensor_V_71, sensor_I_nanoamps_71, hybrid_V_72, hybrid_I_72, sensor_V_72, sensor_I_nanoamps_72, hybrid_V_73, hybrid_I_73, sensor_V_73, sensor_I_nanoamps_73):
    ...
    axs[0,0].scatter(hybrid_V_68, hybrid_I_68, label = "BM 0068", marker = ".")
    axs[0,0].scatter(sensor_V_68, sensor_I_nanoamps_68, label = "Sensor Tile", marker = ".")
    axs[0,0].set_xlabel("Bias Voltage (V)", fontsize = 8)
    axs[0,0].set_ylabel("Leakage Current (nA)", fontsize = 8)
    axs[0,0].set_title("BM 0068 IV", fontsize = 10)
    axs[0,0].legend(loc = "upper left", fontsize = 8)

    axs[0,1].scatter(hybrid_V_70, hybrid_I_70, label = "BM 0070", marker = ".")
    axs[0,1].scatter(sensor_V_70, sensor_I_nanoamps_70, label = "Sensor Tile", marker = ".")
    axs[0,1].set_xlabel("Bias Voltage (V)", fontsize = 8)
    axs[0,1].set_ylabel("Leakage Current (nA)", fontsize = 8)
    axs[0,1].set_title("BM 0070 IV", fontsize = 10)
    axs[0,1].legend(loc = "center right", fontsize = 8)
    ...
    axs[0,2].set_ylabel("Leakage Current (nA)", fontsize = 8)
    axs[0,2].set_title("BM 0071 IV", fontsize = 10)
    axs[0,2].legend(loc = "center right", fontsize = 8)

    axs[1,0].scatter(hybrid_V_72, hybrid_I_72, label = "BM 0072", marker = ".")
    axs[1,0].scatter(sensor_V_72, sensor_I_nanoamps_72, label = "Sensor Tile", marker = ".")
    axs[1,0].set_xlabel("Bias Voltage (V)", fontsize = 8)
    axs[1,0].set_ylabel("Leakage Current (nA)", fontsize = 8)
    axs[1,0].set_title("BM 0072 IV", fontsize = 10)
    axs[1,0].legend(loc = "center right", fontsize = 8)

    axs[1,1].scatter(hybrid_V_73, hybrid_I_73, label = "BM 0073", marker = ".")
    axs[1,1].scatter(sensor_V_73, sensor_I_nanoamps_73, label = "Sensor Tile", marker = ".")
    axs[1,1].set_xlabel("Bias Voltage (V)", fontsize = 8)
    axs[1,1].set_ylabel("Leakage Current (nA)", fontsize = 8)
    axs[1,1].set_title("BM 0073 IV", fontsize = 10)
    axs[1,1].legend(loc = "center right", fontsize = 8)

    fig.delaxes(axs[1,2])

    fig.suptitle("Comparing Hybrid IV and Sensor IV", fontsize = 12)
    fig.tight_layout()
    fig.show()
...
def log_sensor_hybrid(hybrid_V_68, hybrid_I_68, sensor_V_68, sensor_I_nanoamps_68, hybrid_V_70, hybrid_I_70, sensor_V_70, sensor_I_nanoamps_70, hybrid_V_71, hybrid_I_71, sensor_V_71, sensor_I_nanoamps_71, hybrid_V_72, hybrid_I_72, sensor_V_72, sensor_I_nanoamps_72, hybrid_V_73, hybrid_I_73, sensor_V_73, sensor_I_nanoamps_73):
    ...
    axs[0,0].set_xlabel("Bias Voltage (V)", fontsize = 8)
    axs[0,0].set_ylabel("Log [Leakage Current] (nA)", fontsize = 8)
    axs[0,0].set_title("BM 0068 IV - Logarithmic", fontsize = 10)
    ...
    axs[0,1].set_xlabel("Bias Voltage (V)", fontsize = 8)
    axs[0,1].set_ylabel("Log [Leakage Current] (nA)", fontsize = 8)
    axs[0,1].set_title("BM 0070 IV - Logarithmic", fontsize = 10)
    ...
    axs[0,2].set_xlabel("Bias Voltage (V)", fontsize = 8)
    axs[0,2].set_ylabel("Log [Leakage Current] (nA)", fontsize = 8)
    axs[0,2].set_title("BM 0071 IV - Logarithmic", fontsize = 10)
    ...
    axs[1,0].set_xlabel("Bias Voltage (V)", fontsize = 8)
    axs[1,0].set_ylabel("Log [Leakage Current] (nA)", fontsize = 8)
    axs[1,0].set_title("BM 0072 IV - Logarithmic", fontsize = 10)
    ...
    axs[1,1].set_xlabel("Bias Voltage (V)", fontsize = 8)
    axs[1,1].set_ylabel("Log [Leakage Current] (nA)", fontsize = 8)
    axs[1,1].set_title("BM 0073 IV - Logarithmic", fontsize = 10)
    axs[1,1].legend(loc = "lower right", fontsize = 8)

    fig.delaxes(axs[1,2])

    fig.suptitle("Comparing Hybrid and Sensor IV With a Logarithmic Scale", fontsize = 12)
    fig.tight_layout()
    fig.show()
...
def all_five_BMs(hybrid_V_68, hybrid_I_68, hybrid_V_70, hybrid_I_70, hybrid_V_71, hybrid_I_71, hybrid_V_72, hybrid_I_72, hybrid_V_73, hybrid_I_73): 
    ...
    ax[0].scatter(hybrid_V_68, hybrid_I_68, label="BM 0068", marker = ".")    
    ax[0].scatter(hybrid_V_70, hybrid_I_70, label="BM 0070", marker= ".")
    ax[0].scatter(hybrid_V_71, hybrid_I_71, label="BM 0071", marker = ".")    
    ax[0].scatter(hybrid_V_72, hybrid_I_72, label="BM 0072", marker= ".")
    ax[0].scatter(hybrid_V_73, hybrid_I_73, label="BM 0073", marker = ".")  

    ax[0].set_xlabel("Bias Voltage (V)", fontsize = 8)
    ax[0].set_ylabel("Leakage Current (nA)", fontsize = 8)
    ax[0].set_title("IV Curves for Five BMs", fontsize = 10)
...
def lightsOn_lightsOff(hybrid_V_70, hybrid_I_70, hybrid_V_70_lightsOff, hybrid_I_70_lightsOff):
   ...
   plt.ylabel("Leakage Current (nA)", fontsize = 8)
   plt.title("20UPGB420070 Lights On vs. Lights Off", fontsize = 10)
...
def current_in_microamps_68(hybrid_I_68_microamps, hybrid_V_68):
    ...
    plt.title("BM 0068 IV", fontsize = 10)
    plt.show()
...
def current_in_microamps_70(hybrid_I_70_microamps, hybrid_V_70):
    ...
    plt.xlabel("Bias Voltage (V)", fontsize = 8)
    plt.ylabel("Leakage Current (µA)", fontsize = 8)
    plt.title("BM 0070 IV", fontsize = 10)
    plt.show()
...
def current_in_microamps_71(hybrid_I_71_microamps, hybrid_V_71):
    ...
    plt.xlabel("Bias Voltage (V)", fontsize = 8)
    plt.ylabel("Leakage Current (µA)", fontsize = 8)
    plt.title("BM 0071 IV", fontsize = 10)
    plt.show()
...
def current_in_microamps_72(hybrid_I_72_microamps, hybrid_V_72):
    ...
    plt.xlabel("Bias Voltage (V)", fontsize = 8)
    plt.ylabel("Leakage Current (µA)", fontsize = 8)
    plt.title("BM 0072 IV", fontsize = 10)
    plt.show()
...
def current_in_microamps_73(hybrid_I_73_microamps, hybrid_V_73):
    ...
    plt.xlabel("Bias Voltage (V)", fontsize = 8)
    plt.ylabel("Leakage Current (µA)", fontsize = 8)
    plt.title("BM 0073 IV", fontsize = 10)
    plt.show()
